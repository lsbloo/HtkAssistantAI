...
class HtkArgs:
    def __init__(self):
        ...
        self._parser = argparse.ArgumentParser(description="HtkAssistantAI Command Line Interface")
    ...
    def show_documentation(self):
        if self._args.doc:
            ...
            print("--models\tLists the models available in the environment variables, separated by commas.")
            print("--verbose\tEnables verbose output for detailed logging.")
            print("--init\tActivates initialization mode, initialize the tool in mode graphic.")
            print("--doc\tDisplays the documentation for the HtkAssistantAI application.")
            print()
            print()
            print("Documentação da Interface de Linha de Comando do HtkAssistantAI")
            print("Esta aplicação é projetada para auxiliar os usuários com interações alimentadas por IA.")
            print("Para mais informações, visite o site oficial da documentação.")
            print()
            print("Descrição dos Argumentos:")
            print("--------------------------------------------------------------------------------------------------------------------------------------")
            print("Argumento\tDescrição")
            print("--models\tLista os modelos disponíveis nas variáveis de ambiente, separados por vírgulas.")
